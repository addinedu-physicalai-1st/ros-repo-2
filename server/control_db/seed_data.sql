...
FROM (
  VALUES
  ('입구', '쇼핑센터 마트로 들어오는 시작 구간, 입구, 시작, 환영합니다. 마트 들어오는 곳, 진입로, 입구 어디야, 쇼핑 시작하는 곳'),
  ('출구', '쇼핑을 마치고 밖으로 나가는 구간, 퇴장, 안녕히 가세요. 마트 나가는 곳, 출구, 밖으로 나가는 길, 이제 나갈래, 계산하고 나가는 곳'),
  ('화장실', '생리 현상을 해결하는 곳, 화장실, 손 씻기, restroom, toilet, 급해요, 화장실 어디'),
  ('결제 구역', '물건을 다 사고 돈을 내고 계산하는 곳, 캐셔, 계산대, 카운터, 계산하는 곳, 결제하러 가기'),
